...
export const ChangeEmailBackground = styled(ScrollView).attrs({
  scrollEnabled: false,
...
export const ChangeEmailText = styled(Text).attrs({
...
export const ChangeEmailButton = styled(Button).attrs((props) => ({
